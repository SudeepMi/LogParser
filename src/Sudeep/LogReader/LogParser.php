...
class LogParser implements LogParserInterface
{
    ...
    const LOG_CLASS_PATTERN           = "([a-z]+\s[a-z]+|\w+)";
    ...
    public function parseLogContent($content)
    {
        ...
        $pattern = "/^" .self::LOG_DATE_PATTERN. "\s" .self::LOG_ENVIRONMENT_PATTERN. "\." .self::LOG_LEVEL_PATTERN. "\:\s" .self::LOG_CLASS_PATTERN."|"."\|Next/m";
        ...
        return compact('headerSet', 'dateSet', 'envSet', 'levelSet','classSet', 'bodySet');
    }
